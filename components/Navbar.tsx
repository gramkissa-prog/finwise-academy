      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          <div className="flex items-center gap-6">
            ...
            >
              {/* Logo Image - Added white bg in dark mode for visibility of dark text */}
              <img 
                src="/logo.png" 
                alt="Finwise Academy" 
                className="h-14 w-auto object-contain transition-transform group-hover:scale-105 dark:bg-white dark:p-1 dark:rounded-lg"
              />
            </a>
          </div>
